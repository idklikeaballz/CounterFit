...
public class LoseWeight extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        goalRadioGroup = findViewById(R.id.loseweightRadioGroup);
        ...
        nextButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (selectedId != -1) {
                    ...
                    Intent intent = new Intent(LoseWeight.this, SignUp3.class);
                    ...
                    Toast.makeText(LoseWeight.this, "Please select a weight goal", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
